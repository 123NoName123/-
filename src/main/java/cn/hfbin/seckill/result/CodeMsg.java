...
public class CodeMsg {
	...
	public static CodeMsg ACCESS_LIMIT_REACHED_OR_REQUEST_ILLEGAL= new CodeMsg(500105, "访问太频繁!或请求非法");
	//登录模块 5002XX
	...
	//验证码模块 5006XX
	public static CodeMsg CAPTCHA_ERROR = new CodeMsg(500600, "无效的验证码");
	private CodeMsg( ) {
	}
